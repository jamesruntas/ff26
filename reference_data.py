"""The hand-maintained inputs: projected offence rank and bye weeks.

Neither has a free API worth trusting -- sportsbooks price win totals, not
"offence rankings", and bye weeks are schedule trivia nobody bothers to
publish as a clean feed. Transcribing them by hand once and re-checking
offense.csv after cuts is the correct answer here, not a workaround.
...
from config import NFL_TEAMS, REFERENCE, TOP_N_FLAG, norm_team
